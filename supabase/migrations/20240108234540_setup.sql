...
AS $$
DECLARE
  project_url TEXT := 'https://rjnbhktfkretkrmxulvh.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJqbmJoa3Rma3JldGtybXh1bHZoIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxNjEyMTE1MiwiZXhwIjoyMDMxNjk3MTUyfQ.tuiwXBrp9J20ZtpjyAZFWyIw0_9XJBDs8UhzLkSyMh4'; -- full access needed for http request to storage
